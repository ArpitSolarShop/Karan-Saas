...
export class NotificationsController {
  ...
  findUnread(@Query('recipientId') userId?: string) {
    return this.service.findUnread(userId || 'all');
  }
  ...
  findAllSuppressions(@Query('tenantId') tenantId?: string) {
    return this.service.findAllSuppressions(tenantId);
  }

  @Post('notifications/suppressions')
  addSuppression(@Body() body: any) {
    return this.service.addSuppression(body);
  }

  @Get('notifications/dnc-check')
  checkDnc(@Query('phone') phone: string) {
    return this.service.checkDnc(phone);
  }

  @Delete('notifications/suppressions/:id')
  removeSuppression(@Param('id') id: string) {
    return this.service.removeSuppression(id);
  }
  ...
  logAction(@Body() body: any) {
    return this.service.logAction(body);
  }
}
